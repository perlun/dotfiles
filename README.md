...
- [BetterTouchTool]: This one is nice since it will give you shortcuts for moving a window to use the "left half" or "right half" of the screen. I use this all the time to be able to run four programs on two monitors, giving them 50% each. :)
